...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_1_Pin|LED_2_Pin|LD2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_1_Pin LED_2_Pin LD2_Pin */
  GPIO_InitStruct.Pin = LED_1_Pin|LED_2_Pin|LD2_Pin;
